...
stage_list = ["Ref_Check", "build", "HTMLCheck", "IBPSA_Merge", "Update_WhiteList", "Release", "StyleCheck", "check", "openMR", "post", "create_whitelist", "simulate", "RegressionTest", "Update_Ref", "plot_ref", "prepare", "deploy"]
