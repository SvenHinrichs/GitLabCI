...
annotation (Documentation(info="<html><p>
  ...
  according to Guideline VDI 6007 Part 1 (VDI, 2012). The guideline
  defines twelve test cases that consecutively test different aspects
  of building pyhsics behaviour. All tests are based on a simple test
  room, either in a lightweight version (L) or as heavyweight (S). A
  third version changes one interior wall into a second exterior wall
  for the heavyweight construction.
</p>
<p>
