...
package R290_IIR_P05_30_T263_343_Formula
  ...
  */
  ...
  algorithm
    ...
    T := (314.714456959068) + (89.9988984287752) * (((0.049784532) +
      (0.812915722176255)*x^1 + (-0.485252422559269)*x^2 +
      (0.452113517399419)*x^3 + (-0.509758482228388)*x^4 +
      (0.624647765942656)*x^5 + (-0.809987090417357)*x^6 +
      (1.08909694031671)*x^7 + (-1.50075370184942)*x^8 +
      (2.10314346387695)*x^9 + (-3.2101839991522)*x^10 +
      (5.1496074119545)*x^11 + (-0.171965430903563)*x^12 +
      (-14.0609083306686)*x^13 + (-169.618396241937)*x^14 +
      (548.032269738263)*x^15 + (2737.41277992834)*x^16 +
      (-8551.71765339857)*x^17 + (-36365.4299997343)*x^18 +
      (104671.21653575)*x^19 + (354129.363109993)*x^20 +
      (-956016.453555908)*x^21 + (-2588996.07334184)*x^22 +
      (6597033.14683305)*x^23 + (14097753.337877)*x^24 +
      (-34132767.2831829)*x^25 + (-56445981.8598188)*x^26 +
      (130510724.837043)*x^27 + (161410013.061604)*x^28 +
      (-357938868.07772)*x^29 + (-312549990.204649)*x^30 +
      (667046798.608578)*x^31 + (367952699.725659)*x^32 +
      (-757908233.955288)*x^33 + (-199919955.396472)*x^34 +
      (398148862.940126)*x^35));
    annotation(smoothOrder = 2,
          Inline=false,
          LateInline=true);
  ...
  algorithm
    ...
    dl := (479.63605641964) + (158.710809951891) * (((0.0299586382685047) +
      (-0.921191170759037)*x^1 + (-0.31988094531161)*x^2 +
      (-0.241754621811309)*x^3 + (-0.209973677149465)*x^4 +
      (-0.20556940574841)*x^5 + (-0.214228995994567)*x^6 +
      (-0.232292001969948)*x^7 + (-0.257687633710071)*x^8 +
      (-0.295698328266597)*x^9 + (-0.362711228684454)*x^10 +
      (-0.486571806528472)*x^11 + (-0.699142505344287)*x^12 +
      (-1.28146729979824)*x^13 + (-2.73648898021723)*x^14 +
      (-1.02099838936652)*x^15 + (16.240179568742)*x^16 +
      (32.2321439731247)*x^17 + (-38.3089822429208)*x^18 +
      (-167.388526468939)*x^19 + (-34.286073230572)*x^20 +
      (360.650888848736)*x^21 + (259.875445333347)*x^22 +
      (-379.369839448631)*x^23 + (-417.252850518645)*x^24 +
      (102.498679842295)*x^25 + (168.562039493205)*x^26));
    annotation(smoothOrder = 2,
          Inline=false,
          LateInline=true);
  end bubbleDensity;
  ...
  algorithm
    x := (sat.Tsat - (303.15))/(90);
    dv := (28.4811865500103) + (66.6559013317995) * (((-0.0754744015174044) +
      (0.808375476827012)*x^1 + (0.811832008381672)*x^2 +
      (0.590898303947074)*x^3 + (0.495282411314377)*x^4 +
      (0.490192151807828)*x^5 + (0.509690199864535)*x^6 +
      (0.560751132479985)*x^7 + (0.672792235972464)*x^8 +
      (0.923630488185071)*x^9 + (1.35527523720564)*x^10 +
      (1.49114325185849)*x^11 + (-0.739113632299647)*x^12 +
      (-10.2971934822874)*x^13 + (-27.0147438072994)*x^14 +
      (12.9822226129711)*x^15 + (267.637744405501)*x^16 +
      (412.3820502853)*x^17 + (-1051.27601610942)*x^18 +
      (-3122.52067135369)*x^19 + (2253.53926320725)*x^20 +
      (12491.6995976091)*x^21 + (-1861.34451993193)*x^22 +
      (-31858.637385946)*x^23 + (-2370.58912808463)*x^24 +
      (52982.2892015502)*x^25 + (7058.92241323013)*x^26 +
      (-52999.2668562323)*x^27 + (-4790.47306548912)*x^28 +
      (24729.5537485333)*x^29));
    annotation(smoothOrder = 2,
          Inline=false,
          LateInline=true);
  end dewDensity;
  ...
  algorithm
    ...
    hl := (315624.984387066) + (256478.426329608) * (((0.0361438659731507) +
      (0.849926390294104)*x^1 + (-0.34966667159822)*x^2 +
      (0.372237411342447)*x^3 + (-0.381084129429948)*x^4 +
      (0.487787294421858)*x^5 + (-0.610337601733258)*x^6 +
      (0.832473481266347)*x^7 + (-1.13913175345066)*x^8 +
      (1.59069973995372)*x^9 + (-2.26302221729487)*x^10 +
      (3.46672373461629)*x^11 + (-5.32098880051055)*x^12 +
      (2.64758244293881)*x^13 + (6.47029425217843)*x^14 +
      (137.536958919031)*x^15 + (-462.619336965067)*x^16 +
      (-2498.28167363608)*x^17 + (8397.46595050577)*x^18 +
      (40167.0083231862)*x^19 + (-124542.594195178)*x^20 +
      (-486313.365924655)*x^21 + (1416354.0638898)*x^22 +
      (4567071.19402525)*x^23 + (-12561996.4230609)*x^24 +
      (-33235234.3082519)*x^25 + (86860131.7909424)*x^26 +
      (187005402.363897)*x^27 + (-466601813.162386)*x^28 +
      (-805551262.020446)*x^29 + (1926833832.78873)*x^30 +
      (2607836222.80069)*x^31 + (-6000574809.17466)*x^32 +
      (-6142679157.11019)*x^33 + (13636958532.2276)*x^34 +
      (9947264847.89552)*x^35 + (-21359403718.5665)*x^36 +
      (-9916466348.59996)*x^37 + (20637884091.3137)*x^38 +
      (4601044486.87677)*x^39 + (-9294767843.63885)*x^40));
    annotation(smoothOrder = 2,
          Inline=false,
          LateInline=true);
  end bubbleEnthalpy;
  ...
  algorithm
    x := (sat.psat - (1570581.06473046))/(2557900);
    hv := (611770.95439052) + (72569.9367503185) * (((0.0980593948500622) +
      (0.73697777870168)*x^1 + (-0.988765189667206)*x^2 +
      (0.602870738214699)*x^3 + (-0.879264408088915)*x^4 +
      (0.840516589045987)*x^5 + (-1.37432108544607)*x^6 +
      (2.21831905224981)*x^7 + (-1.09461342269619)*x^8 +
      (0.37918804346481)*x^9 + (-12.9134840899498)*x^10 +
      (22.7165909170454)*x^11 + (28.7466309562791)*x^12 +
      (-87.4509889200359)*x^13 + (-118.386708715477)*x^14 +
      (783.380077339674)*x^15 + (-791.349145978091)*x^16 +
      (-7265.37195240485)*x^17 + (18539.6674822496)*x^18 +
      (88279.4166642683)*x^19 + (-263711.217390457)*x^20 +
      (-997509.402878578)*x^21 + (2898773.57918601)*x^22 +
      (9258056.41821587)*x^23 + (-25335355.2373842)*x^24 +
      (-67425029.5319391)*x^25 + (174364505.252102)*x^26 +
      (380310593.940752)*x^27 + (-936106557.039505)*x^28 +
      (-1641348684.22018)*x^29 + (3868950611.13826)*x^30 +
      (5319760814.06607)*x^31 + (-12063991762.716)*x^32 +
      (-12538264110.1784)*x^33 + (27452478313.3802)*x^34 +
      (20309540510.172)*x^35 + (-43051291028.3205)*x^36 +
      (-20247895189.1885)*x^37 + (41644196829.4943)*x^38 +
      (9394086287.20505)*x^39 + (-18775386313.6055)*x^40));
    annotation(smoothOrder = 2,
          Inline=false,
          LateInline=true);
  end dewEnthalpy;
  ...
  algorithm
    x := (sat.psat - (1570581.06473046))/(2557900);
    sl := (1376.30588505819) + (826.068105213303) * (((0.0457609974234471) +
      (0.805470640142587)*x^1 + (-0.435627195532008)*x^2 +
      (0.465184273228716)*x^3 + (-0.506702271997059)*x^4 +
      (0.651059130787342)*x^5 + (-0.838779616598381)*x^6 +
      (1.15217954418816)*x^7 + (-1.60045805379047)*x^8 +
      (2.26101216009097)*x^9 + (-3.24391515196012)*x^10 +
      (5.00328992083909)*x^11 + (-7.85167676769299)*x^12 +
      (3.11268958206643)*x^13 + (12.7752539636391)*x^14 +
      (226.059931948838)*x^15 + (-763.056131634308)*x^16 +
      (-4172.85884728481)*x^17 + (13911.5167143464)*x^18 +
      (66975.5024566354)*x^19 + (-205991.835180489)*x^20 +
      (-810782.536880512)*x^21 + (2341379.49521742)*x^22 +
      (7610600.46375838)*x^23 + (-20756825.7164981)*x^24 +
      (-55358907.3112437)*x^25 + (143483390.503767)*x^26 +
      (311344581.740643)*x^27 + (-770642130.02999)*x^28 +
      (-1340537038.4187)*x^29 + (3182094478.82347)*x^30 +
      (4337708567.68782)*x^31 + (-9909434496.20396)*x^32 +
      (-10212384678.3319)*x^33 + (22520438414.7263)*x^34 +
      (16529163595.4961)*x^35 + (-35274256182.5208)*x^36 +
      (-16468859514.8044)*x^37 + (34083168950.6415)*x^38 +
      (7636274154.59154)*x^39 + (-15349607814.6221)*x^40));
    annotation(smoothOrder = 2,
          Inline=false,
          LateInline=true);
  end bubbleEntropy;
  ...
  algorithm
    x := (sat.psat - (1570581.06473046))/(2557900);
    sv := (2335.75170536325) + (97.9077112667096) * (((-0.00619048868799449) +
      (-0.624499077638527)*x^1 + (-0.113920392204933)*x^2 +
      (-0.759627313555789)*x^3 + (0.66941156982168)*x^4 +
      (-1.50959232991508)*x^5 + (1.58146106221061)*x^6 +
      (-1.42438707828771)*x^7 + (6.58097770859788)*x^8 +
      (-13.0500554559933)*x^9 + (-8.50688453256311)*x^10 +
      (24.4635507698644)*x^11 + (107.45943824896)*x^12 +
      (-224.377993905924)*x^13 + (-343.494332982509)*x^14 +
      (91.0319174951408)*x^15 + (3852.60757433586)*x^16 +
      (16329.6212516804)*x^17 + (-65541.5043152719)*x^18 +
      (-326165.883627773)*x^19 + (1007213.05553646)*x^20 +
      (4105031.67420979)*x^21 + (-11716161.8016396)*x^22 +
      (-38715062.2946953)*x^23 + (104799948.851401)*x^24 +
      (281202937.346275)*x^25 + (-726577962.8212)*x^26 +
      (-1578181058.50373)*x^27 + (3904793200.14042)*x^28 +
      (6783508534.79747)*x^29 + (-16120343329.1663)*x^30 +
      (-21921194748.1992)*x^31 + (50177422017.5857)*x^32 +
      (51553752249.9676)*x^33 + (-113970547248.801)*x^34 +
      (-83356734431.6106)*x^35 + (178399484846.286)*x^36 +
      (82962121367.1925)*x^37 + (-172242854661.379)*x^38 +
      (-38415276654.6987)*x^39 + (77490431827.9399)*x^40));
    annotation(smoothOrder = 2,
          Inline=false,
          LateInline=true);
  end dewEntropy;
  ...
  */
  ...
  algorithm
    ...
    if h<h_bubble-dh then
      ...
      T := (0) + (1) * (291.384236041825 + (-0.0704729863184529)*x1^1 +
        (-0.00678884566695906)*x1^2 + (0.000202836611783306)*x1^3 +
        (-9.71248676197528e-06)*x1^4 + (7.98267274869292e-07)*x1^5 +
        (20.5578417380748)*y1^1 + (-0.770247506716285)*y1^2 +
        (-0.038647246926071)*y1^3 + (-0.00751600683912493)*y1^4 +
        (-0.0016300055996751)*y1^5 + (-1.12691051342428e-05)*x1^4*y1^1 +
        (0.000273729410002939)*x1^3*y1^1 + (0.000134930636679386)*x1^3*y1^2 +
        (-0.0044760279738207)*x1^2*y1^1 + (-0.00177519423682889)*x1^2*y1^2 +
        (-0.000392485634748443)*x1^2*y1^3 + (0.136811720776647)*x1^1*y1^1 +
        (0.0309332207143316)*x1^1*y1^2 + (0.00767135438646387)*x1^1*y1^3 +
        (0.00140205757787774)*x1^1*y1^4);
    elseif h>h_dew+dh then
      x2 := (p-(382099.574228781))/(403596.556578661);
      y2 := (h-(639399.497939419))/(37200.2691858212);
      T := (0) + (1) * (308.060027778396 + (6.59039876392094)*x2^1 +
        (0.0453108439023189)*x2^2 + (0.00540769150996739)*x2^3 +
        (-0.000196566506959251)*x2^4 + (-4.64422678045603e-05)*x2^5 +
        (20.795024314138)*y2^1 + (-0.411365889418558)*y2^2 +
        (-0.00497446957449581)*y2^3 + (0.0046513295424428)*y2^4 +
        (-0.000577281104194347)*y2^5 + (0.000787074643540945)*x2^4*y2^1 +
        (-0.00847992074678385)*x2^3*y2^1 + (0.00281445602040784)*x2^3*y2^2 +
        (-0.0188305448625778)*x2^2*y2^1 + (0.00660309588666398)*x2^2*y2^2 +
        (-0.00176606807260317)*x2^2*y2^3 + (-1.43969687581506)*x2^1*y2^1 +
        (0.255977908649908)*x2^1*y2^2 + (-0.0432200997543392)*x2^1*y2^3 +
        (0.00590025752789791)*x2^1*y2^4);
    else
      if h<h_bubble then
        x1 := (p-(1682457.5126701))/(720642.233056887);
        y1 := (h-(247137.397786416))/(54003.5903158973);
        T1 := (0) + (1) * (291.384236041825 + (-0.0704729863184529)*x1^1 +
          (-0.00678884566695906)*x1^2 + (0.000202836611783306)*x1^3 +
          (-9.71248676197528e-06)*x1^4 + (7.98267274869292e-07)*x1^5 +
          (20.5578417380748)*y1^1 + (-0.770247506716285)*y1^2 +
          (-0.038647246926071)*y1^3 + (-0.00751600683912493)*y1^4 +
      ...
      elseif h>h_dew then
        x2 := (p-(382099.574228781))/(403596.556578661);
        y2 := (h-(639399.497939419))/(37200.2691858212);
        T2 := (0) + (1) * (308.060027778396 + (6.59039876392094)*x2^1 +
          (0.0453108439023189)*x2^2 + (0.00540769150996739)*x2^3 +
          (-0.000196566506959251)*x2^4 + (-4.64422678045603e-05)*x2^5 +
          (20.795024314138)*y2^1 + (-0.411365889418558)*y2^2 +
          (-0.00497446957449581)*y2^3 + (0.0046513295424428)*y2^4 +
  ...
  algorithm
    ...
    if s<s_bubble-ds then
      ...
      T := (0) + (1) * (290.574168937952 + (0.490828546245446)*x1^1 +
        (0.117871744016533)*x1^2 + (0.0181671755438826)*x1^3 +
        (0.00191602988674819)*x1^4 + (0.00011497599662102)*x1^5 +
        (19.8608752914032)*y1^1 + (-0.040817223566116)*y1^2 +
        (-0.0857625427384498)*y1^3 + (-0.0124017661200968)*y1^4 +
        (-0.00192723964571896)*y1^5 + (0.000243666235393007)*x1^4*y1^1 +
        (0.0037715016370504)*x1^3*y1^1 + (0.000459514035453056)*x1^3*y1^2 +
        (0.0292848788419663)*x1^2*y1^1 + (0.00622225803519055)*x1^2*y1^2 +
        (0.00090717580273224)*x1^2*y1^3 + (0.130154107880201)*x1^1*y1^1 +
        (0.0324083687227166)*x1^1*y1^2 + (0.00799217399325639)*x1^1*y1^3 +
        (0.00127247920370296)*x1^1*y1^4);
    elseif s>s_dew+ds then
      x2 := (log(p)-(12.3876547448383))/(0.961902709412239);
      y2 := (s-(2715.6535956075))/(207.473158311391);
      T := (0) + (1) * (305.667994209752 + (34.3546579581206)*x2^1 +
      (0.95682930429454)*x2^2 + (0.129780738468536)*x2^3 +
      (0.0577060502424694)*x2^4 + (0.0132124973316544)*x2^5 +
      (36.3220486736092)*y2^1 + (0.702977715170277)*y2^2 +
      (-0.100508863694088)*y2^3 + (0.0160903628800248)*y2^4 +
      (-0.00049456983306658)*y2^5 + (-0.00720862103838031)*x2^4*y2^1 +
      (-0.0264862744961215)*x2^3*y2^1 + (0.00736011556482272)*x2^3*y2^2 +
      (-0.30336257516708)*x2^2*y2^1 + (0.0826586807740864)*x2^2*y2^2 +
      (-0.00773556171071259)*x2^2*y2^3 + (0.23922945375389)*x2^1*y2^1 +
      (0.00081428356388169)*x2^1*y2^2 + (-0.00125351482775024)*x2^1*y2^3 +
      (0.0036583657279175)*x2^1*y2^4);
    else
      if s<s_bubble then
        x1 := (log(p)-(14.2251890031606))/(0.499169296800688);
        y1 := (s-(1152.46506841802))/(179.299713840403);
        T1 := (0) + (1) * (290.574168937952 + (0.490828546245446)*x1^1 +
          (0.117871744016533)*x1^2 + (0.0181671755438826)*x1^3 +
          (0.00191602988674819)*x1^4 + (0.00011497599662102)*x1^5 +
          (19.8608752914032)*y1^1 + (-0.040817223566116)*y1^2 +
          (-0.0857625427384498)*y1^3 + (-0.0124017661200968)*y1^4 +
      ...
      elseif s>s_dew then
        x2 := (log(p)-(12.3876547448383))/(0.961902709412239);
        y2 := (s-(2715.6535956075))/(207.473158311391);
        T2 := (0) + (1) * (305.667994209752 + (34.3546579581206)*x2^1 +
        (0.95682930429454)*x2^2 + (0.129780738468536)*x2^3 +
        (0.0577060502424694)*x2^4 + (0.0132124973316544)*x2^5 +
        (36.3220486736092)*y2^1 + (0.702977715170277)*y2^2 +
        (-0.100508863694088)*y2^3 + (0.0160903628800248)*y2^4 +
  ...
  algorithm
    if p<sat.psat-dp then
      ...
      d := (0) + (1) * (6.99012116216078 + (7.85762798977443)*x1^1 +
        (0.561456406237816)*x1^2 + (0.0745135118619033)*x1^3 +
        (0.0141066470211284)*x1^4 + (0.00292620516208197)*x1^5 +
        (-0.618509525341628)*y1^1 + (0.0644646531072409)*y1^2 +
        (-0.00894774750115025)*y1^3 + (0.00116677386847406)*y1^4 +
        (-2.13433530006928e-05)*y1^5 + (-0.01655069884562)*x1^4*y1^1 +
        (-0.0614336770277778)*x1^3*y1^1 + (0.0269207717408464)*x1^3*y1^2 +
        (-0.227438027200113)*x1^2*y1^1 + (0.0715858695051831)*x1^2*y1^2 +
        (-0.0137994983041971)*x1^2*y1^3 + (-0.827135398454184)*x1^1*y1^1 +
        (0.113487112138254)*x1^1*y1^2 + (-0.021065201099773)*x1^1*y1^3 +
        (0.00162333280148309)*x1^1*y1^4);
    elseif p>sat.psat+dp then
      x2 := (p-(1682457.5126701))/(720642.233056887);
      y2 := (T-(290.645659315997))/(19.9347318052857);
      d := (0) + (1) * (506.208387981876 + (1.8705425621798)*x2^1 +
        (-0.0351624357762205)*x2^2 + (0.00126962771607607)*x2^3 +
        (7.69903677841526e-06)*x2^4 + (1.34663813731525e-05)*x2^5 +
        (-29.9062841232497)*y2^1 + (-2.21393734916457)*y2^2 +
        (-0.419234944193293)*y2^3 + (-0.104815271970145)*y2^4 +
        (-0.0227711391125435)*y2^5 + (1.90380071619604e-06)*x2^4*y2^1 +
        (0.00219916470789359)*x2^3*y2^1 + (0.00117322708291575)*x2^3*y2^2 +
        (-0.0298496253585084)*x2^2*y2^1 + (-0.0156164603769147)*x2^2*y2^2 +
        (-0.00424731659901982)*x2^2*y2^3 + (0.693501535440458)*x2^1*y2^1 +
        (0.222243208624831)*x2^1*y2^2 + (0.0699901864638379)*x2^1*y2^3 +
        (0.0141806356166424)*x2^1*y2^4);
    else
      if p<sat.psat then
        x1 := (p-(382099.574228781))/(403596.556578661);
        y1 := (T-(307.564799259815))/(22.5879133275781);
        d1 := (0) + (1) * (6.99012116216078 + (7.85762798977443)*x1^1 +
          (0.561456406237816)*x1^2 + (0.0745135118619033)*x1^3 +
          (0.0141066470211284)*x1^4 + (0.00292620516208197)*x1^5 +
          (-0.618509525341628)*y1^1 + (0.0644646531072409)*y1^2 +
          (-0.00894774750115025)*y1^3 + (0.00116677386847406)*y1^4 +
      ...
      elseif p>=sat.psat then
        x2 := (p-(1682457.5126701))/(720642.233056887);
        y2 := (T-(290.645659315997))/(19.9347318052857);
        d2 := (0) + (1) * (506.208387981876 + (1.8705425621798)*x2^1 +
          (-0.0351624357762205)*x2^2 + (0.00126962771607607)*x2^3 +
          (7.69903677841526e-06)*x2^4 + (1.34663813731525e-05)*x2^5 +
          (-29.9062841232497)*y2^1 + (-2.21393734916457)*y2^2 +
          (-0.419234944193293)*y2^3 + (-0.104815271970145)*y2^4 +
...
end R290_IIR_P05_30_T263_343_Formula;
