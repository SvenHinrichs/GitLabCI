...
<p>
  Simple controller for Throttle and ThrottlePump circuit. The
  controlled variable needs to be connected to Tact.
</p>
<p>
  If the valve is fully closed, the pump will switch off.
</p>
</html>"));
end CtrThrottle;
