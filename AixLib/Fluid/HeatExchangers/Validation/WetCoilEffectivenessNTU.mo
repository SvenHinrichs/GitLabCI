...
model WetCoilEffectivenessNTU
  ...
  package Medium_W = AixLib.Media.Water;
  package Medium_A = AixLib.Media.Air;
  ...
  AixLib.Utilities.Psychrometrics.ToTotalAir conversion
  ...
  AixLib.Utilities.Psychrometrics.TWetBul_TDryBulXi wetBulIn(redeclare package
  ...
  AixLib.Utilities.Psychrometrics.TWetBul_TDryBulXi wetBulOut(redeclare package
              Medium = Medium_A) "Computation of wet bulb temperature"
  ...
  AixLib.Fluid.HeatExchangers.WetCoilEffectivenessNTU hexWetNTU(
  ...
  AixLib.Fluid.HeatExchangers.WetCoilEffectivenessNTU hexWetNTU_TX(
    redeclare package Medium1 = Medium_W,
    redeclare package Medium2 = Medium_A,
