...
model WetCoilWetRegime
  ...
  input AixLib.Fluid.Types.HeatExchangerFlowRegime cfg
  ...
  AixLib.Utilities.Psychrometrics.hSat_pTSat hSatWatInM(p=pAir,TSat=TWatIn)
  ...
  AixLib.Utilities.Psychrometrics.hSat_pTSat hSatWatIn_dT_M(p=pAir,TSat=TWatIn+dTWat)
  ...
  AixLib.Utilities.Psychrometrics.hSat_pTSat hSatWatOutM(p=pAir,TSat=TWatOutEst)
  ...
  AixLib.Utilities.Psychrometrics.hSat_pTSat hSatSurEffM(p=pAir,TSat=TSurEff)
...
equation
  ...
  hAirIn=AixLib.Media.Air.specificEnthalpy_pTX(
  ...
  NonZerDelWatTem=AixLib.Utilities.Math.Functions.regNonZeroPower(
    x=TWatOutEst-TWatIn,n=1,delta=0.1);
  cpEff = AixLib.Utilities.Math.Functions.smoothMax(
    (hSatWatOut - hSatWatIn)/NonZerDelWatTem,
    dhSatdTWatIn,
    cpEff0*delta);

  CStaMin=AixLib.Utilities.Math.Functions.smoothMin(
    mAir_flow,
  ...
  hSatSurEff = AixLib.Utilities.Math.Functions.smoothMax(
  ...
  QSen_flow= AixLib.Utilities.Math.Functions.smoothMin(
