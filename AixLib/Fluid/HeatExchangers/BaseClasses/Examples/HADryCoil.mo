...
model HADryCoil "Test model for dry coil convection coefficient"
  ...
  AixLib.Fluid.HeatExchangers.BaseClasses.HADryCoil hADryCoiAir(
    m_flow_nominal_w=0.1,
    UA_nominal=10000,
  ...
  AixLib.Fluid.HeatExchangers.BaseClasses.HADryCoil hADryCoiWat(
    m_flow_nominal_w=0.1,
    UA_nominal=10000,
    m_flow_nominal_a=2.5,
...
equation
  ...
  annotation ( __Dymola_Commands(file=
          "modelica://AixLib/Resources/Scripts/Dymola/Fluid/HeatExchangers/BaseClasses/Examples/HADryCoil.mos"
        "Simulate and plot"),
