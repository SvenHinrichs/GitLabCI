...
model WetCoilEffectivenessNTUMassFlow
  ...
  AixLib.Fluid.HeatExchangers.WetCoilEffectivenessNTU hex(
    ...
    UA_nominal=Q_flow_nominal/AixLib.Fluid.HeatExchangers.BaseClasses.lmtd(
      T_a1_nominal,
      T_b1_nominal,
      T_a2_nominal,
      T_b2_nominal),
...
equation
  ...
  annotation (
    ...
    __Dymola_Commands(
    file="modelica://AixLib/Resources/Scripts/Dymola/Fluid/HeatExchangers/Examples/WetCoilEffectivenessNTUMassFlow.mos"
      "Simulate and plot"),
