...
model WetCoilEffectivenessNTU
  ...
  extends AixLib.Fluid.Interfaces.PartialFourPortInterface(
    redeclare replaceable package Medium2 = AixLib.Media.Air);
  ...
  Modelica.Units.SI.HeatFlowRate QLat2_flow=AixLib.Utilities.Psychrometrics.Constants.h_fg
...
protected
  ...
  Real delta1=1E-1
    "Parameter for normalization";
  Real fac1 = AixLib.Utilities.Math.Functions.smoothMin(
    (1/delta * m1_flow/m1_flow_nominal)^2,1,delta1);
  Real fac2 = AixLib.Utilities.Math.Functions.smoothMin(
    (1/delta * m2_flow/m2_flow_nominal)^2,1,delta1);
  Real Qfac = fac1*fac2;

  AixLib.Fluid.HeatExchangers.BaseClasses.WetCoilUARated UAFroRated(
  ...
  AixLib.Fluid.HeatExchangers.HeaterCooler_u heaCoo(
  ...
  AixLib.Fluid.Humidifiers.Humidifier_u heaCooHum_u(
  ...
  AixLib.Fluid.HeatExchangers.BaseClasses.WetCoilDryWetRegime dryWetCalcs(
  ...
  Modelica.Blocks.Sources.RealExpression m_flow_a1Exp(
    final y=AixLib.Utilities.Math.Functions.regNonZeroPower(
