...
model Outside_CpData_Angles
  ...
  AixLib.Fluid.Sources.Outside_CpData symNor(
  ...
  AixLib.Fluid.Sources.Outside_CpData asyNor(
    redeclare package Medium = Medium,
    incAngSurNor=incAngSurNor,
    Cp=CpAsy,
    azi=AixLib.Types.Azimuth.N)
  ...
  AixLib.Fluid.Sources.Outside_CpData asyWes(
    redeclare package Medium = Medium,
    incAngSurNor=incAngSurNor,
    Cp=CpAsy,
  ...
  AixLib.Fluid.Sources.Outside_CpData symWes(
    redeclare package Medium = Medium,
    incAngSurNor=incAngSurNor,
    Cp=CpSym,
    azi=AixLib.Types.Azimuth.W)
