...
record Generic "Generic data record for movers"
  ...
  parameter AixLib.Fluid.Movers.BaseClasses.Characteristics.flowParameters pressure(
    V_flow = {0, 0},
  ...
  parameter Real constantSpeed(final min=0, final unit="1") = constantSpeed_rpm/speed_rpm_nominal
    "Normalized speed set point, used if inputType = AixLib.Fluid.Types.InputType.Constant"
    annotation (Dialog(group="Normalized speeds (used in model, default values assigned from speeds in rpm)"));
...
<a href=\"modelica://AixLib.Fluid.Movers.Validation.Pump_Nrpm_stratos\">
AixLib.Fluid.Movers.Validation.Pump_Nrpm_stratos</a>.
</p>
