within AixLib.Fluid.Movers.Validation.BaseClasses;
model ControlledFlowMachine
  ...
  AixLib.Fluid.Sensors.MassFlowRate masFloRat1(redeclare package Medium =
        Medium)
    annotation (Placement(transformation(extent={{60,50},{80,70}})));
  AixLib.Fluid.Sensors.RelativePressure relPre(redeclare package Medium =
  ...
  AixLib.Fluid.Movers.SpeedControlled_y fan1(
    ...
    redeclare AixLib.Fluid.Movers.Data.Pumps.Wilo.Stratos32slash1to12 per)
  ...
  AixLib.Fluid.Sensors.MassFlowRate masFloRat2(
    redeclare package Medium = Medium)
  ...
  AixLib.Fluid.Sensors.MassFlowRate masFloRat3(
    redeclare package Medium = Medium)
    annotation (Placement(transformation(extent={{60,-70},{80,-50}})));
  AixLib.Fluid.Movers.FlowControlled_dp fan3(
    redeclare package Medium = Medium,
  ...
  AixLib.Fluid.Sensors.MassFlowRate masFloRat4(
    redeclare package Medium = Medium)
    annotation (Placement(transformation(extent={{60,100},{80,120}})));
  AixLib.Fluid.Movers.SpeedControlled_Nrpm fan4(
    redeclare package Medium = Medium,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
    redeclare AixLib.Fluid.Movers.Data.Pumps.Wilo.Stratos32slash1to12 per)
