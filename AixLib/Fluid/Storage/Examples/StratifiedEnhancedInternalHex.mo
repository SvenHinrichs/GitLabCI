...
model StratifiedEnhancedInternalHex
  ...
  AixLib.Fluid.Sources.Boundary_pT bouWat(redeclare package Medium =
    ...
    "Boundary condition for water (used to set pressure)" annotation (Placement(
        ...
        rotation=180,
        origin={70,-12})));
  AixLib.Fluid.Sources.Boundary_pT solColSup(
  ...
  AixLib.Fluid.Sources.Boundary_pT toSolCol(
    redeclare package Medium = MediumHex,
    nPorts=3,
    ...
    T=283.15) "Water to solar collector" annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        origin={-72,-20})));
  AixLib.Fluid.Storage.StratifiedEnhancedInternalHex tanSte(
  ...
  AixLib.Fluid.Sensors.TemperatureTwoPort senTemSte(
    redeclare package Medium = MediumHex,
    allowFlowReversal=false,
  ...
  AixLib.Fluid.Storage.StratifiedEnhancedInternalHex tanDynSol(
    redeclare package Medium = MediumTan,
    m_flow_nominal=0.001,
    VTan=0.151416,
    dIns=0.0762,
  ...
  AixLib.Fluid.Sensors.TemperatureTwoPort senTemDynSol(
    redeclare package Medium = MediumHex,
    allowFlowReversal=false,
    m_flow_nominal=mHex_flow_nominal,
    tau=0)
...
equation
  ...
  annotation ( __Dymola_Commands(file=
          "modelica://AixLib/Resources/Scripts/Dymola/Fluid/Storage/Examples/StratifiedEnhancedInternalHex.mos"
        "Simulate and plot"),
