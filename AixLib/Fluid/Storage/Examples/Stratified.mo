...
model Stratified "Test model for stratified tank"
 ...
 package Medium = AixLib.Media.Water "Medium model";
  ...
  AixLib.Fluid.Storage.StratifiedEnhanced tanEnh(
    redeclare package Medium = Medium,
    hTan=3,
    dIns=0.3,
    nSeg=10,
  ...
  AixLib.Fluid.Sensors.EnthalpyFlowRate HOut_flow(redeclare package Medium =
        Medium, m_flow_nominal=0.1) "Enthalpy flow rate"
                                     annotation (Placement(transformation(
          extent={{6,2},{22,18}})));
  AixLib.Fluid.Sensors.EnthalpyFlowRate HOut_flow1(redeclare package Medium =
        Medium, m_flow_nominal=0.1) "Enthalpy flow rate"
                                     annotation (Placement(transformation(
          extent={{18,-36},{34,-20}})));
