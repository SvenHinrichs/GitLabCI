 ...
 package Medium = AixLib.Media.Water;
  ...
  AixLib.Fluid.Sources.Boundary_pT sin_1(                       redeclare
    ...
    startTime=0) "Control signal"
            ...
            194}})));
  AixLib.Fluid.HeatExchangers.HeaterCooler_u hea2(
    redeclare package Medium = Medium,
    Q_flow_nominal=5000,
    m_flow_nominal=0.5,
    dp_nominal=200,
  ...
  AixLib.Fluid.HeatExchangers.HeaterCooler_u hea3(
    redeclare package Medium = Medium,
    Q_flow_nominal=5000,
    m_flow_nominal=0.5,
    dp_nominal=200,
  ...
  AixLib.Fluid.HeatExchangers.HeaterCooler_u hea4(
  ...
  AixLib.Fluid.HeatExchangers.HeaterCooler_u hea5(
    redeclare package Medium = Medium,
    Q_flow_nominal=5000,
    m_flow_nominal=0.5,
    dp_nominal=200,
  ...
  AixLib.Fluid.HeatExchangers.HeaterCooler_u hea6(
  ...
  AixLib.Fluid.HeatExchangers.HeaterCooler_u hea7(
    redeclare package Medium = Medium,
    Q_flow_nominal=5000,
    m_flow_nominal=0.5,
    dp_nominal=200,
  ...
  AixLib.Fluid.HeatExchangers.HeaterCooler_u hea8(
    redeclare package Medium = Medium, Q_flow_nominal=5000,
    m_flow_nominal=0.5,
    dp_nominal=200,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
