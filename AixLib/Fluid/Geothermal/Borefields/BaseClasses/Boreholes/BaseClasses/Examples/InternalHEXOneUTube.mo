...
model InternalHEXOneUTube
  ...
  AixLib.Fluid.Sources.MassFlowSource_T boundary(nPorts=1,
    redeclare package Medium = Medium,
    m_flow=borFieDat.conDat.mBor_flow_nominal,
    T=293.15)
    annotation (Placement(transformation(extent={{-48,-4},{-28,16}})));
  AixLib.Fluid.Sources.MassFlowSource_T boundary1(nPorts=1,
    redeclare package Medium = Medium,
    m_flow=borFieDat.conDat.mBor_flow_nominal,
    T=293.15)
    annotation (Placement(transformation(extent={{54,4},{34,-16}})));
  AixLib.Fluid.Sources.Boundary_pT bou(nPorts=2, redeclare package Medium = Medium)
