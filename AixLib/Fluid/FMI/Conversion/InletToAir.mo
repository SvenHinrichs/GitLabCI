within AixLib.Fluid.FMI.Conversion;
block InletToAir
  "Conversion from real signals for a fluid to a AixLib.Fluid.FMI.Interfaces.Inlet connector"
  ...
  AixLib.Fluid.FMI.Interfaces.Inlet inlet(
