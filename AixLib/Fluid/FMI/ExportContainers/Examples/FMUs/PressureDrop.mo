...
block PressureDrop
  "Declaration of an FMU that exports a fixed resistance"
   extends AixLib.Fluid.FMI.ExportContainers.ReplaceableTwoPort(
     redeclare replaceable package Medium = AixLib.Media.Air, redeclare final
...
__Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Fluid/FMI/ExportContainers/Examples/FMUs/PressureDrop.mos"
        "Export FMU"),
    Icon(graphics={
        Rectangle(
          extent={{-64,24},{70,-26}},
