...
model PlugFlowPipe "Simple example of plug flow pipe"
  ...
  AixLib.Fluid.FixedResistances.PlugFlowPipe pipNoMix(
    have_pipCap=false,
    redeclare package Medium = Medium,
    dh=0.1,
    length=100,
...
equation
  ...
  connect(Tin.y, souNoMix.T_in) annotation (Line(points={{-79,0},{-68,0},{-68,
          -16},{-62,-16}},
                      color={0,0,127}));
  annotation (
    __Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Fluid/FixedResistances/Examples/PlugFlowPipe.mos"
        "Simulate and Plot"),
