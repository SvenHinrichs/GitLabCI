...
model CheckValve "Example model for check valve"
  ...
  AixLib.Fluid.Sources.Boundary_pT sin(
    ...
    annotation (Placement(transformation(
          extent={{50,-10},{30,10}})));
  AixLib.Fluid.FixedResistances.CheckValve checkValve(
    redeclare package Medium = AixLib.Media.Water,
    m_flow_nominal=2,
    dpValve_nominal=3600)
    "Check valve"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
  AixLib.Fluid.FixedResistances.CheckValve checkValveDpFix(
  ...
  AixLib.Fluid.FixedResistances.CheckValve checkValve_m_flow(
    redeclare package Medium = Media.Water,
    m_flow_nominal=2,
    dpValve_nominal=3600)
