...
equation
  ...
  annotation (Icon(graphics={
        ...
        Text(
          ...
          fillColor={215,215,215},
          fillPattern=FillPattern.Solid,
          textString="ERC")}),    Documentation(info="<html><h4>
...
\"Load according to type of activity\">
  <tr>
...
<p>
  The surface for radiation exchange is constant throught the
  simulation, as the machines are always present in the room. For
  stability reasons a lower limitation of 1e-4 m2 has been introduced.
</p>
<h4>
