...
equation
  ...
  annotation (Icon(graphics={
        ...
        Text(
          ...
          fillColor={215,215,215},
          fillPattern=FillPattern.Solid,
          textString="simple")}),    Documentation(info="<html><h4>
  <span style=\"color:#008000\">Overview</span>
</h4>
<p>
  Heat source with convective and radiative component. The load is
  determined by a power input signal.
</p>
<h4>
  <span style=\"color:#008000\">Concept</span>
</h4>
<p>
  The input signal can take values from 0 to an arbitrary maximum
  value.
</p>
<h4>
...
<p>
  The parameter A cannot be set by default since other models must be
  able to implement their own equations for A. For example in the model
  <a href=
  \"Building.Components.Sources.InternalGains.Machines.Machines_Avar\">Machines_Avar</a>
  a changing radiative area is implemented.
</p>
<h4>
...
<p>
  <a href=
  \"AixLib.Building.Examples.Sources.InternalGains.Machines\">AixLib.Building.Examples.Sources.InternalGains.Machines</a>
</p>
</html>",
    revisions="<html><ul>
  <li>
