...
block IntegratorWithReset "Output the integral of the input signal"
  ...
  */
  ...
  parameter Real y_reset = 0
    "Value to which integrator is reset, used if reset = AixLib.Types.Reset.Parameter"
    annotation(Evaluate=true,
               Dialog(
                 enable=reset == AixLib.Types.Reset.Parameter,
...
equation
  ...
  if reset == AixLib.Types.Reset.Disabled then
...
Icon(coordinateSystem(
        ...
        graphics={
          ...
          visible=reset == AixLib.Types.Reset.Input,
          horizontalAlignment=TextAlignment.Left),
        Bitmap(extent={{-54,-50},{60,50}}, fileName=
              "modelica://AixLib/Resources/Images/Utilities/Math/int.png"),
          Text(
            extent={{-88,56},{206,92}},
          lineColor={0,0,0},
          textString="k=%k",
