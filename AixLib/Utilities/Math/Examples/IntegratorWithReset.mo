...
model IntegratorWithReset "Test model for integrator with reset"
  ...
  AixLib.Utilities.Math.IntegratorWithReset intWitRes1(
    y_start=5, reset=AixLib.Types.Reset.Parameter,
    k=0.5,
    y_reset=2)                                      "Integrator with reset"
    annotation (Placement(transformation(extent={{-10,20},{10,40}})));

  AixLib.Utilities.Math.IntegratorWithReset intWitRes2(
    y_reset=10,
    y_start=-5,
  ...
  AixLib.Utilities.Math.IntegratorWithReset intNoReset(
  ...
  AixLib.Utilities.Math.IntegratorWithReset intDef
