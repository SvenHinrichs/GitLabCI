...
model FallingFactorial "Test model for falling factorial function "
  ...
  AixLib.Utilities.Math.FallingFactorial falFac "Falling factorial"
...
__Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Utilities/Math/Examples/FallingFactorial.mos"
        "Simulate and plot"), Documentation(info="<html>
<p>
This model tests the implementation of
<a href=\"modelica://AixLib.Utilities.Math.FallingFactorial\">
AixLib.Utilities.Math.FallingFactorial</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
