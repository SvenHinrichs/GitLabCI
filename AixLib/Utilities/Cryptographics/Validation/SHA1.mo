within AixLib.Utilities.Cryptographics.Validation;
...
equation
  cmp1 = Modelica.Utilities.Strings.isEqual(AixLib.Utilities.Cryptographics.sha(strIn1),strEx1,false);
  cmp2 = Modelica.Utilities.Strings.isEqual(AixLib.Utilities.Cryptographics.sha(strIn2),strEx2,false);
  cmp3 = Modelica.Utilities.Strings.isEqual(AixLib.Utilities.Cryptographics.sha(strIn3),strEx3,false);
  cmp4 = Modelica.Utilities.Strings.isEqual(AixLib.Utilities.Cryptographics.sha(strIn4),strEx4,false);
  cmp5 = Modelica.Utilities.Strings.isEqual(AixLib.Utilities.Cryptographics.sha(strIn5),strEx5,false);
