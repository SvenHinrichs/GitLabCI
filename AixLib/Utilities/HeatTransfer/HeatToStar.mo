...
<p>
  ...
  connector. To model longwave radiation exchange of surfaces, just
  connect the <b><a href=
  \"Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a\">HeatPort</a></b>
  connector to the outmost layer of the surface and connect the
  <b><a href=\"AixLib.Utilities.Interfaces.RadPort\">Star</a></b>
  connector to the <b><a href=
  \"AixLib.Utilities.Interfaces.RadPort\">Star</a></b> connectors of an
  unlimited number of corresponding surfaces.
</p>
<h4>
